...
proc multi_wait*(multi_handle: PM, extra_fds: ptr UncheckedArray[WaitFd],
                 extra_nfds: uint32, timeout_ms: int32, ret: var int32): Mcode{.
    cdecl, dynlib: libname, importc: "curl_multi_wait".}
proc multi_poll*(multi_handle: PM, extra_fds: ptr UncheckedArray[WaitFd],
                 extra_nfds: uint32, timeout_ms: int32, ret: var int32): Mcode{.
